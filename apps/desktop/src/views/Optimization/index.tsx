    ...
    <div className="h-full flex flex-col p-4 space-y-4 overflow-hidden">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={loadData}
          disabled={isLoading}
          className="flex items-center gap-2 px-3 py-1.5 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed"
        >
